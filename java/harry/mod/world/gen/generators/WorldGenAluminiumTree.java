...
{
	public static final IBlockState LOG = BlockInit.LOGS.getDefaultState().withProperty(BlockBaseLogs.VARIANT, EnumHandler.EnumType.ALUMINIUM);
	public static final IBlockState LEAF = BlockInit.LEAVES.getDefaultState().withProperty(BlockBaseLeaf.VARIANT, EnumHandler.EnumType.ALUMINIUM);
	...
	public boolean generate(World world, Random rand, BlockPos pos) 
	{
		...
		else
		{
			...
			boolean isSoil = state.getBlock().canSustainPlant(state, world, down, EnumFacing.UP, (BlockBaseSaplings)BlockInit.SAPLINGS);
