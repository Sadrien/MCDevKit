...
{
	public static final IBlockState LOG = BlockInit.LOGS.getDefaultState().withProperty(BlockBaseLogs.VARIANT, EnumHandler.EnumType.COPPER);
	public static final IBlockState LEAF = BlockInit.LEAVES.getDefaultState().withProperty(BlockBaseLeaf.VARIANT, EnumHandler.EnumType.COPPER);
