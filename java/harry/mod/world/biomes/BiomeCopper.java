...
public class BiomeCopper extends Biome 
{
	...
	public BiomeCopper() 
	{
		...
		topBlock = BlockInit.DIRT.getDefaultState().withProperty(BlockBaseDirts.VARIANT, EnumHandler.EnumType.COPPER);
		fillerBlock = BlockInit.ORE_OVERWORLD.getDefaultState().withProperty(BlockBaseOres.VARIANT, EnumHandler.EnumType.COPPER);
		
		this.decorator.coalGen = new WorldGenMinable(BlockInit.PLANKS.getDefaultState().withProperty(BlockBasePlanks.VARIANT, EnumHandler.EnumType.COPPER), 10);
